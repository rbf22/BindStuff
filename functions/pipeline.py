...
def run_pipeline(target_settings, advanced_settings, filters, design_models, prediction_models, multimer_validation, design_paths, trajectory_csv, mpnn_csv, final_csv, failure_csv, settings_file, filters_file, advanced_file, trajectory_labels, design_labels, final_labels):
